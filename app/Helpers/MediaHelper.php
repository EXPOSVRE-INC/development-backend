...
class MediaHelper
{
    ...
    public static function muteMediaAudio($inputPath, $outputPath)
    {
        ...
        $ffmpegCommand = [
            'C:\\Program Files\\ffmpeg\\bin\\ffmpeg.exe', // Adjust path if necessary
            '-i', $inputPath,
            '-an', // Remove audio
    ...
    {
        self::cleanupFile($originalPath); // Delete original file
        return rename($newPath, $originalPath); // Rename new file to original path
    }
