...
//                'collection_post' => (bool) $this->collection_post,
                ...
                'totalPrice' => $this->isFree ? (integer) $this->shippingPrice / 100 : (integer) ( $this->fixed_price / 100 +  $this->shippingPrice / 100 + $this->fixed_price / 100 * 0.059 +  $this->fixed_price / 100 * 0.0825 ),
